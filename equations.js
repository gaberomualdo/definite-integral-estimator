  ...
  return (function a(b, c, d) {
  ...
  })(
    {
      1: [
        function (a, b, c) {
          'use strict';
          Object.defineProperty(c, '__esModule', { value: !0 }), (c.default = { PI: Math.PI, E: Math.E, RAND: Math.random }), (b.exports = c.default);
        },
        {},
      ],
      2: [
        function (a, b, c) {
          ...
          var i = function a(b, c, d) {
            ...
            var f = !0,
              ...
              h = void 0;
            try {
              for (var i, j = c[Symbol.iterator](); !(f = (i = j.next()).done); f = !0) {
                var k = i.value;
                e.push(a(b, k, d));
              }
            } catch (l) {
      ...
      3: [
        function (a, b, c) {
          ...
          var h = a('./readstream'),
            ...
            u = function (a) {
              a = a.replace(/,/g, ')(');
              for (var b = new i.default(a), c = [], d = '', e = void 0, f = void 0; b.next(); )
                if (((e = b.current()), (f = c.length - 1), ' ' !== e))
                  if (o.isNumber(e) || k.default[e] || '.' === e || '(' === e || ')' === e)
                    if (d.length) {
                      var g = f - (d.length - 1);
                      D(d) && o.isNumber(c[g]) && c.push('*'), c.push(d, e), (d = '');
                    } else if (o.isNumber(c[f]) && (o.isNumber(e) || '.' === e)) c[f] += e;
                    else if ('-' === c[f]) {
                      var h = c[f - 1];
                      k.default[h] ? (c[f] += e) : ')' === h ? ((c[f] = '+'), c.push('-' + e)) : o.isNumber(h) || D(h) ? c.push(e) : (c[f] += e);
                    } else c.push(e);
                  else d += e;
              if (d.length) {
                var g = f - (d.length - 1);
            ...
            v = function (a) {
              ...
              return a.reduce(function (a, c) {
                return (
                  c.indexOf('(') > -1
                    ? (c.length > 1 ? o.dive(a, b).push(c.replace('(', ''), []) : o.dive(a, b).push([]), b++)
                    : ')' === c
                    ? b--
                    : o.dive(a, b).push(c),
                  a
            ...
            x = function a(b) {
              var c = !0,
                ...
                e = void 0;
              try {
                for (var f, h = b.entries()[Symbol.iterator](); !(c = (f = h.next()).done); c = !0) {
                  var i = g(f.value, 2),
                    j = i[0],
                    l = i[1];
            ...
            C = '()[]{}'.split(''),
            D = function (a) {
              return 'string' == typeof a && !o.isNumber(a) && !k.default[a] && a === a.toLowerCase() && -1 === C.indexOf(a);
            };
          (c.isVariable = D), (c.default = p);
        },
        { './constants': 1, './helpers': 2, './operators': 4, './readstream': 5, 'babel/polyfill': 8 },
      ],
      4: [
        function (a, b, c) {
          'use strict';
          ...
          c.default = {
            ...
            sigma: {
              fn: function (a, b, c) {
                for (var d = c.join('').replace(/,/g, ''), e = new RegExp(g, 'g'), h = 0, i = a; i <= b; i++) h += f.default.solve(d.replace(e, i));
                return h;
              },
              format: '1000',
              hasExpression: !0,
      ...
      6: [
        function (a, b, c) {
          (function (b) {
            'use strict';
            if ((a('core-js/shim'), a('regenerator/runtime'), b._babelPolyfill)) throw new Error('only one instance of babel/polyfill is allowed');
            b._babelPolyfill = !0;
          ...
          b.exports =
            ...
            function (a, b) {
              var c = d(this),
                ...
                m = 1;
              for (i < h && h < i + l && ((m = -1), (i += l - 1), (h += l - 1)); l-- > 0; ) i in c ? (c[h] = c[i]) : delete c[h], (h += m), (i += m);
              return c;
            };
        },
      ...
      15: [
        ...
        { './$.array-species-create': 16, './$.ctx': 24, './$.iobject': 41, './$.to-length': 86, './$.to-object': 87 },
      ],
      16: [
        function (a, b, c) {
          var d = a('./$.is-object'),
          ...
          b.exports = function (a, b) {
            ...
            return (
              e(a) &&
                ((c = a.constructor),
                'function' != typeof c || (c !== Array && !e(c.prototype)) || (c = void 0),
          ...
          b.exports = {
            ...
            def: function (a, b, c) {
              ...
              return (
                f
                  ? (f.v = c)
                  : ((a._l = f = { i: (e = u(b, !0)), k: b, v: c, p: (d = a._l), n: void 0, r: !1 }),
                    a._f || (a._f = f),
                    d && (d.n = f),
                    a[s]++,
                    'F' !== e && (a._i[e] = f)),
            ...
            (b.exports = {
              getConstructor: function (a, b, c, d) {
                ...
                return (
                  e(f.prototype, {
                    delete: function (a) {
                      return !!g(a) && (m(a) ? k(a, l) && k(a[l], this._i) && delete a[l][this._i] : q(this).delete(a));
                    },
                    has: function (a) {
                      return !!g(a) && (m(a) ? k(a, l) && k(a[l], this._i) : q(this).has(a));
                    },
                  }),
                  f
                );
      ...
      29: [
          ...
          var d = a('./$.global'),
            ...
            j = function (a, b, c) {
              ...
              for (k in c)
                (l = !o && t && k in t),
                  (m = (l ? t : c)[k]),
                  (n = s && l ? h(m, d) : r && 'function' == typeof m ? h(Function.call, m) : m),
                  t && !l && g(t, k, m),
                  u[k] != m && f(u, k, n),
                  r && v[k] != m && (v[k] = m);
            };
        ...
        { './$.core': 23, './$.ctx': 24, './$.global': 36, './$.hide': 38, './$.redefine': 68 },
      ],
      30: [
        function (a, b, c) {
          var d = a('./$.wks')('match');
      ...
      32: [
        ...
        { './$.defined': 25, './$.fails': 31, './$.hide': 38, './$.redefine': 68, './$.wks': 90 },
      ],
      33: [
        function (a, b, c) {
          'use strict';
      ...
      34: [
        function (a, b, c) {
          ...
          b.exports = function (a, b, c, j) {
            ...
            if (f(n)) for (k = h(a.length); k > p; p++) b ? o(g((l = a[p]))[0], l[1]) : o(a[p]);
            else for (m = n.call(a); !(l = m.next()).done; ) e(m, o, l.value, b);
          };
        },
        { './$.an-object': 11, './$.ctx': 24, './$.is-array-iter': 42, './$.iter-call': 47, './$.to-length': 86, './core.get-iterator-method': 91 },
      ],
      35: [
        function (a, b, c) {
          var d = a('./$.to-iobject'),
      ...
      48: [
        ...
        { './$': 53, './$.hide': 38, './$.property-desc': 66, './$.set-to-string-tag': 73, './$.wks': 90 },
      ],
      49: [
        function (a, b, c) {
          'use strict';
          ...
          b.exports = function (a, b, c, s, t, u, v) {
            ...
            if (((d && !v) || (!n && !B && C[m]) || g(C, m, E), (i[b] = E), (i[z] = r), t))
              if (((w = { values: A ? E : y(q), keys: u ? E : y(p), entries: A ? y('entries') : E }), v)) for (x in w) x in C || f(C, x, w[x]);
        ...
        function (a, b, c) {
          ...
          (a('./$.core').inspectSource = function (a) {
            ...
            (b.exports = function (a, b, c, g) {
              'function' == typeof c &&
                (c.hasOwnProperty(f) || e(c, f, a[b] ? '' + a[b] : i.join(String(b))), c.hasOwnProperty('name') || e(c, 'name', b)),
      ...
      82: [
        ...
        { './$.cof': 18, './$.ctx': 24, './$.dom-create': 27, './$.global': 36, './$.html': 39, './$.invoke': 40 },
      ],
      83: [
        function (a, b, c) {
          var d = a('./$.to-integer'),
      ...
      91: [
        ...
        { './$.classof': 17, './$.core': 23, './$.iterators': 52, './$.wks': 90 },
      ],
      92: [
        function (a, b, c) {
          'use strict';
          ...
          g ||
            ...
            f(f.S + f.F * !g, 'Object', { getOwnPropertyDescriptor: e.getDesc, defineProperty: e.setDesc, defineProperties: G });
            ...
            f(
              ...
              'Array',
              {
                slice: function (a, b) {
                  ...
                  for (var e = u(a, c), f = u(b, c), g = v(f - e), h = Array(g), i = 0; i < g; i++)
              ...
              return function (b, c) {
                ...
                if (arguments.length < 2)
                  for (;;) {
                    ...
                    if (((f += g), a ? f < 0 : e <= f)) throw TypeError('Reduce of empty array with no initial value');
                  }
          ...
          f(f.P, 'Array', {
            ...
            lastIndexOf: function (a, b) {
              var c = s(this),
                d = v(c.length),
                e = d - 1;
              for (arguments.length > 1 && (e = Math.min(e, t(b))), e < 0 && (e = v(d + e)); e >= 0; e--) if (e in c && c[e] === a) return e;
              return -1;
            },
          }),
            f(f.S, 'Date', {
      ...
      93: [
        function (a, b, c) {
          var d = a('./$.export');
          d(d.P, 'Array', { copyWithin: a('./$.array-copy-within') }), a('./$.add-to-unscopables')('copyWithin');
        },
        { './$.add-to-unscopables': 10, './$.array-copy-within': 12, './$.export': 29 },
      ],
      94: [
        function (a, b, c) {
          var d = a('./$.export');
          d(d.P, 'Array', { fill: a('./$.array-fill') }), a('./$.add-to-unscopables')('fill');
        },
        { './$.add-to-unscopables': 10, './$.array-fill': 13, './$.export': 29 },
      ],
      95: [
        function (a, b, c) {
          'use strict';
        ...
        { './$.add-to-unscopables': 10, './$.array-methods': 15, './$.export': 29 },
      ],
      96: [
        function (a, b, c) {
          'use strict';
          ...
          e(
            ...
            'Array',
            {
              from: function (a) {
                ...
                else for (k = s.call(l), c = new m(); !(e = k.next()).done; r++) c[r] = q ? g(k, p, [e.value, r], !0) : e.value;
                return (c.length = r), c;
              },
            }
          );
      ...
      98: [
        ...
        { './$.add-to-unscopables': 10, './$.iter-define': 49, './$.iter-step': 51, './$.iterators': 52, './$.to-iobject': 85 },
      ],
      99: [
        function (a, b, c) {
          'use strict';
      ...
      102: [
        ...
        { './$': 53, './$.descriptors': 26, './$.has': 37, './$.property-desc': 66 },
      ],
      103: [
        function (a, b, c) {
          'use strict';
      ...
      112: [
        function (a, b, c) {
          ...
          d(d.S, 'Math', {
            hypot: function (a, b) {
              for (var c, d, f = 0, g = 0, h = arguments, i = h.length, j = 0; g < i; )
                (c = e(h[g++])), j < c ? ((d = j / c), (f = f * d * d + 1), (j = c)) : c > 0 ? ((d = c / j), (f += d * d)) : (f += c);
            ...
            q = function (a) {
              ...
              if ('string' == typeof b && b.length > 2) {
                ...
                if (43 === f || 45 === f) {
                  ...
                  for (var g, i = b.slice(2), k = 0, l = i.length; k < l; k++) if ((g = i.charCodeAt(k)) < 48 || g > e) return NaN;
                  return parseInt(i, d);
                }
              }
              return +b;
      ...
      145: [
        function (a, b, c) {
            ...
            A = (function () {
              ...
              try {
                if (
                  ((c = x && x.resolve && z()),
                  p(b, x),
                  (b.prototype = e.create(x.prototype, { constructor: { value: b } })),
                      ...
                      h = function (b) {
                        ...
                        try {
                          g
                            ? (e || (a.h = !0),
                              (c = !0 === g ? d : g(d)),
                              c === b.promise ? i(TypeError('Promise-chain cycle')) : (f = D(c)) ? f.call(c, h, i) : h(c))
                            : i(d);
                        } catch (j) {
                          i(j);
                        }
                      ...
                      setTimeout(function () {
                        ...
                        H(e) &&
                          (w
                            ...
                            : (c = g.console) && c.error && c.error('Unhandled promise rejection', d)),
                          (a.a = void 0);
                      }, 1);
                });
              }
          ...
          A ||
            ((x = function (a) {
              m(a);
              var b = (this._d = { p: n(this, x, u), c: [], a: void 0, s: 0, d: !1, v: void 0, h: !1, n: !1 });
              try {
                a(h(J, b, 1), h(I, b, 1));
              } catch (c) {
                I.call(b, c);
            ...
            a('./$.redefine-all')(x.prototype, {
              then: function (a, b) {
                var c = new E(s(this, x)),
                  ...
                  e = this._d;
                return (
                  (c.ok = 'function' != typeof a || a), (c.fail = 'function' == typeof b && b), e.c.push(c), e.a && e.a.push(c), e.s && G(e, !1), d
                );
              },
              catch: function (a) {
      ...
      147: [
        ...
        { './$': 53, './$.a-function': 9, './$.an-object': 11, './$.core': 23, './$.export': 29, './$.fails': 31, './$.is-object': 45 },
      ],
      148: [
        function (a, b, c) {
          var d = a('./$'),
      ...
      153: [
        ...
        { './$': 53, './$.an-object': 11, './$.export': 29, './$.has': 37, './$.is-object': 45 },
      ],
      154: [
        function (a, b, c) {
          var d = a('./$.export');
      ...
      159: [
        function (a, b, c) {
          function d(a, b, c) {
            ...
            return f(m, 'value')
              ? !(!1 === m.writable || !j(l)) && ((g = e.getDesc(l, b) || h(0)), (g.value = c), e.setDesc(l, b, g), !0)
        ...
        { './$': 53, './$.an-object': 11, './$.export': 29, './$.has': 37, './$.is-object': 45, './$.property-desc': 66 },
      ],
      160: [
        function (a, b, c) {
          var d = a('./$'),
          ...
          !a('./$.descriptors') ||
            (m &&
              !a('./$.fails')(function () {
                return (l[a('./$.wks')('match')] = !1), h(k) != k || h(l) == l || '/a/i' != h(k, 'i');
              })) ||
            ((h = function (a, b) {
              var c = f(a),
                d = void 0 === b;
              return this instanceof h || !c || a.constructor !== h || !d
                ? m
                  ...
                  : i((c = a instanceof h) ? a.source : a, c && d ? g.call(a) : b)
                : a;
            }),
      ...
      161: [
        function (a, b, c) {
          var d = a('./$');
          a('./$.descriptors') && 'g' != /./g.flags && d.setDesc(RegExp.prototype, 'flags', { configurable: !0, get: a('./$.flags') });
        },
      ...
      168: [
        ...
        { './$.export': 29, './$.fails-is-regexp': 30, './$.string-context': 78, './$.to-length': 86 },
      ],
      169: [
        function (a, b, c) {
          var d = a('./$.export'),
      ...
      170: [
        ...
        { './$.export': 29, './$.fails-is-regexp': 30, './$.string-context': 78 },
      ],
      171: [
        function (a, b, c) {
          'use strict';
      ...
      177: [
        ...
        { './$': 53, './$.collection': 22, './$.collection-weak': 21, './$.has': 37, './$.is-object': 45, './$.redefine': 68 },
      ],
      178: [
        function (a, b, c) {
          'use strict';
      ...
      179: [
        ...
        { './$.add-to-unscopables': 10, './$.array-includes': 14, './$.export': 29 },
      ],
      180: [
        function (a, b, c) {
          var d = a('./$.export');
      ...
      182: [
        ...
        { './$': 53, './$.export': 29, './$.own-keys': 63, './$.property-desc': 66, './$.to-iobject': 85 },
      ],
      183: [
        function (a, b, c) {
          var d = a('./$.export'),
      ...
      191: [
        function (a, b, c) {
          ...
          i('pop,reverse,shift,keys,values,entries', 1),
            i('indexOf,every,some,forEach,map,filter,find,findIndex,includes', 3),
            i('join,slice,concat,push,splice,unshift,sort,lastIndexOf,reduce,reduceRight,copyWithin,fill'),
            e(e.S, 'Array', h);
        },
      ...
      192: [
        ...
        { './$.global': 36, './$.hide': 38, './$.iterators': 52, './$.wks': 90, './es6.array.iterator': 98 },
      ],
      193: [
        function (a, b, c) {
          var d = a('./$.export'),
      ...
      194: [
        ...
        { './$.export': 29, './$.global': 36, './$.invoke': 40, './$.partial': 64 },
      ],
      195: [
        function (a, b, c) {
          a('./modules/es5'),
          ...
          (function (a, c) {
            !(function (c) {
              ...
              function p(a) {
                if (a) {
                  ...
                  if (!isNaN(a.length)) {
                    var c = -1,
                      d = function b() {
                        for (; ++c < a.length; ) if (s.call(a, c)) return (b.value = a[c]), (b.done = !1), b;
              ...
              (g.prototype = B.constructor = h),
                ...
                (v.mark = function (a) {
                  return Object.setPrototypeOf ? Object.setPrototypeOf(a, h) : (a.__proto__ = h), (a.prototype = Object.create(B)), a;
                }),
                (v.awrap = function (a) {
                  return new j(a);
                }),
                ...
                (o.prototype = {
                  ...
                  delegateYield: function (a, b, c) {
                    return (this.delegate = { iterator: p(a), resultName: b, nextLoc: c }), A;
                  },
                });
